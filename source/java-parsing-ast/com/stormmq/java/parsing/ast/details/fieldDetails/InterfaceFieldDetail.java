...
public final class InterfaceFieldDetail extends AbstractConstantFieldDetail
{
	public InterfaceFieldDetail(@NotNull final String fieldName, @NotNull final TypeUsage typeUsage, final boolean isDeprecatedInByteCode, final boolean isSynthetic, @NotNull final FieldValueDetail fieldValueDetail, @NotNull final AnnotationInstanceDetail[] annotationInstanceDetails)
	{
