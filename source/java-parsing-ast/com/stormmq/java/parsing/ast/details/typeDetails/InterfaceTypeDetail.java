...
public final class InterfaceTypeDetail extends AbstractClassOrInterfaceOrEnumTypeDetail
{
	public InterfaceTypeDetail(@NotNull final Origin origin, @NotNull final KnownReferenceTypeName ourTypeReferenceName, @NotNull final Visibility visibility, final boolean isDeprecatedInByteCode, final boolean isStrictFloatingPoint, final boolean isSynthetic, @NotNull final AnnotationInstanceDetail[] annotationInstanceIntermediates, @NotNull final KnownReferenceTypeName[] interfaceTypeReferenceNames)
	{
